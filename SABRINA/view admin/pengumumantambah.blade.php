...
<html lang="en">
  ...
  <div class="nampak">
    ...
    <section >
    <h3 style="text-align: center; font-family: 'Nunito', sans-serif; font-weight:bold;">Aploud Pengumuman Warga</h3>
    <br>
    ...
    <form action="/admin/pengumuman" method="post" enctype="multipart/form-data">
      @csrf
              <div class="form-group">
                ...
                <div class="form-group">
                <label for="deskripsi">File lampiran :</label>
                    <input type="file" name="dokumen" id="dokumen" class="form-control pg @error('dokumen') is-invalid @enderror" 
                    value="{{ old('dokumen') }}"/>
                    @error('dokumen')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary float-right">Aploud</button>
              </div>
