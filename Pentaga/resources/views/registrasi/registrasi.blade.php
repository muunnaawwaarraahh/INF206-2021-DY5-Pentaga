...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets_regis/css/style.css" />
</head>
<body>

    <div class="regis-text">
        <h1 style="text-align: center; padding-top:10px ; color:white; font-family: Courier, monospace">FORM REGISTRASI WARGA</h1>
    </div>
    <div class="registration-form" style="padding-top:10px" autocomplete="off">
        ...
        @csrf
            <div class="form-icon">
                <div>
                <span>
                  <img src="../assets_regis\img\logo1.png">
                </span>
                </div>
            </div>
    ...
    <script src="../assets_regis/js/script.js"></script>
</body>
</html>
