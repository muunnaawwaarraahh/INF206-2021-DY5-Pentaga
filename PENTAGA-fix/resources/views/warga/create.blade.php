...
<html lang="en">
  ...
  <body id="body-pd" >
    ...
    <section >
    <h3 style="text-align: center; font-family: 'Nunito', sans-serif; font-weight:bold;">Form Isi Data Diri Warga</h3>
    <br>
    <h6 style="color:#7E1818;">Baca panduan terlebih dahulu, harap mengisikan data diri sesuai dengan instruksi di bawah ini!</h6>
    <u style="color:#7E1818; ">
    <h6 style="font-size:2em;"> Isi Data Cukup satu kali!</h6>
    </u> 
    <div class="col-11"  >
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              value="{{ old('kepemilikanRumah') }}">
                  <option disabled selected >Pilih disini</option>
                  <option value="Sendiri" {{ old('kepemilikanRumah') == 'Sendiri' ? 'selected' : '' }}>Sendiri</option>
                  <option value="Sewa" {{ old('kepemilikanRumah') == "Sewa" ? 'selected' : '' }}>Sewa</option>
          ...
          <div class="form-group">
              ...
              value="{{ old('pernahMenerimaBantuan') }}">
                  <option disabled selected>Pilih disini</option>
                  <option value="Ya" {{ old('pernahMenerimaBantuan') == "Ya" ? 'selected' : '' }}>Ya</option>
                    <option value="Tidak" {{ old('pernahMenerimaBantuan') == "Tidak" ? 'selected' : '' }}>Tidak</option>
          ...
          <div class="form-group">
              <label for="tagihanListrikPerbulan">Tagihan Listrik Perbulan :</label>
                ...
                value="{{ old('tagihanListrikPerbulan') }}">
                  <option selected disabled>Pilih disini</option>
                  <option value="Rp.50.000,00 - Rp.200.000,00" {{ old('tagihanListrikPerbulan') == "Rp.50.000,00 - Rp.200.000,00" ? 'selected' : '' }}>Rp.50.000,00 - Rp.200.000,00</option>
                        <option value="Rp.200.000,00 - Rp.400.000,00" {{ old('tagihanListrikPerbulan') == "Rp.200.000,00 - Rp.400.000,00" ? 'selected' : '' }}>Rp.200.000,00 - Rp.400.000,00</option>
                        <option value=">Rp.500.000,00" {{ old('tagihanListrikPerbulan') == ">Rp.500.000,00" ? 'selected' : '' }}>>Rp.500.000,00</option>
                  @error('tagihanListrik')
                      <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </select>
                <label for="tagihanListrikPerbulanBukti" class="form-control">Uplouded File: ({{ old('tagihanListrikPerbulanBukti') }})</label>
                <input type="file" name="tagihanListrikPerbulanBukti" class="form-control @error('tagihanListrikPerbulanBukti') is-invalid @enderror"  value="{{ old('tagihanListrikPerbulanBukti') }}" />
          ...
          <div class="form-group">
              <label for="tagihanAirPerbulan">Tagihan Air Perbulan (jika ada) :</label>
                ...
                value="{{ old('tagihanAirPerbulan') }}">
                  <option value="0" selected>Pilih disini</option>
                  <option value="Rp.50.000,00 - Rp.200.000,00" {{ old('tagihanAirPerbulan') == "Rp.50.000,00 - Rp.200.000,00" ? 'selected' : '' }}>Rp.50.000,00 - Rp.200.000,00</option>
                    <option value="Rp.200.000,00 - Rp.400.000,00" {{ old('tagihanAirPerbulan') == "Rp.200.000,00 - Rp.400.000,00" ? 'selected' : '' }}>Rp.200.000,00 - Rp.400.000,00</option>
                    <option value=">Rp.500.000,00" {{ old('tagihanAirPerbulan') == ">Rp.500.000,00" ? 'selected' : '' }}>>Rp.500.000,00</option>
                </select>
                @error('tagihanAirPerbulan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror

                <label for="tagihanAirPerbulanBukti" class="form-control">Uplouded File: ({{ old('tagihanAirPerbulanBukti') }})</label>
                <input type="file" name="tagihanAirPerbulanBukti" id="tagihanAirBuktiPerbulan" class="form-control @error('tagihanAirPerbulanBukti') is-invalid @enderror " value="{{ old('tagihanAirPerbulanBukti') }}"/>
          ...
          <div class="form-group">
              <label for="konstruksiRumah">Konstruksi Rumah :</label>
                ...
                value="{{ old('konstruksiRumah') }}">
                  <option value="null" selected disabled>Pilih disini</option>
                  <option value="Permanen" {{ old('konstruksiRumah') == "Permanen" ? 'selected' : '' }}>Permanen</option>
                    <option value="Semi-Permanen" {{ old('konstruksiRumah') == "Semi-Permanen" ? 'selected' : '' }}>Semi-Permanen</option>
                    <option value="Non-Permanen" {{ old('konstruksiRumah') == "Non-Permanen" ? 'selected' : '' }}>Non-Permanen</option>
                  @error('konstruksiRumah')
                      <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </select>

                <label for="konstruksiRumahBukti" class="form-control">Uplouded File: ({{ old('konstruksiRumahBukti') }})</label>
                <input type="file" name="konstruksiRumahBukti" id="konstruksiRumah" class="form-control @error('konstruksiRumahBukti') is-invalid @enderror" 
                value="{{ old('konstruksiRumahBukti') }}"/>
